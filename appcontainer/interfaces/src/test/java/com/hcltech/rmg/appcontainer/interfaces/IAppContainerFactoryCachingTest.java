...
public class IAppContainerFactoryCachingTest {
    ...
    public static class TestFactory implements IAppContainerFactory<String, String, String> {
        ...
        static Function<String, ErrorsOr<AppContainer<String, String, String>>> creator =
        ...
        @Override
        public ErrorsOr<AppContainer<String, String, String>> create(String id) {
