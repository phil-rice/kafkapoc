...
//        final XmlTypeClass<Map<String, Object>, XMLValidationSchema> xml = new WoodstoxXmlForMapStringObjectTypeClass();
    ...
    private static KafkaConfig eventHubKafkaConfig(String topicOrNull) {
        String connectionString = resolveEventHubConnectionString();
        ...
        KafkaConfig base = KafkaConfig.fromSystemProps(topicOverride);
    ...
    private static String resolveEventHubConnectionString() {
        String fromSystem = System.getProperty(EVENT_HUB_CONN_PROP);
