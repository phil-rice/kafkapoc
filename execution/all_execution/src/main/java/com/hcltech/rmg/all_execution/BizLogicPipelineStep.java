...
public class BizLogicPipelineStep<ESC, CepState, Msg, Schema> {
    ...
    public BizLogicPipelineStep(AppContainer<ESC, CepState, Msg, Schema> container, Supplier<CepEventLog> cepStateSupplier, String module) {
        this.module = module;
