 ...
 */
public class ParseMessagePipelineStep<MSC, CepState, Msg, Schema,FlinkRT,MetricParam> {
    ...
    public ParseMessagePipelineStep(AppContainer<MSC, CepState, Msg, Schema,FlinkRT,MetricParam> container) {
