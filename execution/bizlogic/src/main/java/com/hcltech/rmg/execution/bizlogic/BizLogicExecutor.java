...
public class BizLogicExecutor<CepState, Msg> implements AspectExecutor<BizLogicAspect, ValueEnvelope<CepState, Msg>, ValueEnvelope<CepState, Msg>> {
    ...
    public BizLogicExecutor(BehaviorConfig config, CelRuleBuilderFactory factory, Class<Msg> msgClass) {
        aspectRepository.register(CelInlineLogic.class, CelInlineLogicExecutor.create(factory, config, msgClass));
