 ...
 */
public interface BehaviorConfigVisitor {
    // Root & container nodes
    default void onConfig(BehaviorConfig config) {}
    ...
    default void onFixedEnrichment(String eventName, String moduleName, MapLookupEnrichment e) {}
    // BizLogic family
