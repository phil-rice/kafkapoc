...
public final class FixedEnrichmentFixture {
    ...
    // ---------- Typeclasses ----------
    public static PathTC<List<String>> ptc() { return new ListPathTC(); }
    public static NodeTC<FixedEnrichment, List<String>> ntc() { return new FixedEnrichmentNodeTC(); }

    // ---------- Path / set helpers ----------
    public static List<String> path(String... segs) { return List.of(segs); }
    ...
    @SafeVarargs
    public static <T> Set<T> set(T... xs) { return new LinkedHashSet<>(asList(xs)); }
