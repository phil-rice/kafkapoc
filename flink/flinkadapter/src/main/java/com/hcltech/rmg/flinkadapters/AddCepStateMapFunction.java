 ...
 */
public class AddCepStateMapFunction<MSC, CepState, Msg, Schema> extends RichMapFunction<Tuple2<String, RawMessage>, Envelope<CepState, Msg>> {
    ...
    public AddCepStateMapFunction(Class<IAppContainerFactory<MSC, CepState, Msg, Schema>> factoryClass, String containerId) {
