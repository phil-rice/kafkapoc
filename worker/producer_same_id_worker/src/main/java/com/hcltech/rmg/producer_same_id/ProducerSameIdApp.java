...
public class ProducerSameIdApp {
    private static final Logger log = LoggerFactory.getLogger(ProducerSameIdApp.class);
...
//        Codec<TestDomainMessage, String> codec = Codec.clazzCodec(TestDomainMessage.class);
    ...
    private static Properties loadApplicationProperties() {
        ...
        try (InputStream is = ProducerSameIdApp.class.getClassLoader().getResourceAsStream("application.properties")) {
